        ...
        >
          ...
          <div className="relative flex flex-col items-center overflow-hidden">
            <motion.h1
              ...
              className="text-center text-4xl font-extrabold tracking-[0.25em] text-foreground sm:text-6xl"
            >
              NEXYN STUDIOS
            </motion.h1>
            <motion.div
            ...
            <motion.span
              ...
              className="mt-3 text-[10px] font-medium tracking-[0.2em] text-muted-foreground uppercase"
            >
          ...
          <div className="absolute bottom-16 flex flex-col items-center gap-1.5">
            <span className="animate-pulse text-[10px] font-semibold tracking-[0.15em] text-muted-foreground/40 uppercase">
